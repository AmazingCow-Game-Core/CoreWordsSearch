...
#ifndef __CoreWordsSearch_include_CoreWordsSearch_h__
#define __CoreWordsSearch_include_CoreWordsSearch_h__

//This is a umbrella header indented to ease the inclusion of all files
//needed to use the WordsSearch Game Core.
...
#endif // defined(__CoreWordsSearch_include_CoreWordsSearch_h__) //
